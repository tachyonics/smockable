...
/// The `VariablesImplementationGenerator` is designed to generate Swift variable declarations
...
/// ```
/// the `VariablesImplementationGenerator` generates the following declarations:
/// ```swift
/// var text: String {
///     get { underlyingText }
...
enum VariablesImplementationGenerator {
    ...
    static func variablesDeclarations(
    ...
    private static func protocolVariableDeclarationWithGetterAndSetter(
    ...
    private static func underlyingVariableDeclaration(
    ...
    private static func underlyingVariableName(
        binding: PatternBindingListSyntax.Element
    ) throws
        -> String
    {
