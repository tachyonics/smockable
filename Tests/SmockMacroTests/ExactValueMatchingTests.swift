...
struct ExactValueMatchingTests {
    ...
    func testAllIntegerTypes() async {
        ...
        when(expectations.processInt32(value: 2147483647), return: "Int32: 2147483647")
        when(expectations.processInt64(value: 9223372036854775807), return: "Int64: max")
        ...
        when(expectations.processUInt32(value: 4294967295), return: "UInt32: 4294967295")
        when(expectations.processUInt64(value: 18446744073709551615), return: "UInt64: max")
        ...
        #expect(await mock.processInt32(value: 2147483647) == "Int32: 2147483647")
        #expect(await mock.processInt64(value: 9223372036854775807) == "Int64: max")
        ...
        #expect(await mock.processUInt32(value: 4294967295) == "UInt32: 4294967295")
        #expect(await mock.processUInt64(value: 18446744073709551615) == "UInt64: max")
    }
    ...
    func testComplexOptionalExactMatching() async {
        ...
        when(expectations.optionalMixFunction(name: .exact("John"), age: .exact(25), score: .exact(95.5)), return: "all exact")
        when(expectations.optionalMixFunction(name: .exact(nil), age: .exact(nil), score: .exact(nil)), return: "all nil")
        when(expectations.optionalMixFunction(name: .exact("Jane"), age: .exact(nil), score: .exact(87.2)), return: "mixed exact")
