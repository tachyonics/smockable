...
//
//  ComplexSendableTypesTests.swift
//  SmockMacroTests
//
...
struct ComplexSendableTypesTests {
    ...
    func testArrayParameterVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected arrayParam(strings: any) to be called exactly 3 times, but was called 2 times"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
    ...
    func testDictionaryParameterVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected dictParam(metadata: any) to never be called, but was called 1 time"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
    ...
    func testSetParameterVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected setParam(numbers: any) to be called at least 2 times, but was called 1 time"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
    ...
    func testGenericSendableVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected genericSendableParam(value: any) to be called at most 1 time, but was called 3 times"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
    ...
    func testSpecificSendableTypeVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected uuidParam(id: any) to be called 2...4 times, but was called 1 time"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
    ...
    func testComplexMixedParametersVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected complexMixedParams(name: any, ids: any, config: any, enabled: any, data: any, sendable: any) to be called at least once, but was never called"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
            when(
                expectations.complexMixedParams(
            ...
            verify(mock, .atLeastOnce).complexMixedParams(
                name: .any,
                ids: .any,
                config: .any,
                enabled: .any,
    ...
    func testSpecificCollectionValueVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected arrayParam(strings: [\"exact1\", \"exact2\"]) to be called exactly 1 time, but was called 0 times"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
            when(expectations.arrayParam(strings: .any), times: .unbounded, return: "array result")
    ...
    func testRangeMatchingWithSendableTypesVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected mixedWithArray(name: \"a\"...\"m\", items: any, enabled: any) to never be called, but was called 1 time"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
    ...
    func testEmptyCollectionSpecificVerificationFailures() {
        expectVerificationFailures(messages: [
            "Expected arrayParam(strings: []) to be called exactly 1 time, but was called 0 times"
        ]) {
            var expectations = MockTestComplexSendableService.Expectations()
